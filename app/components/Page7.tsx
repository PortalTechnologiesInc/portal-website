  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-center overflow-y-auto" style={{ backgroundColor: "#ffffff" }}>
      ...
      <div className="relative z-50 flex flex-col items-center justify-center px-6 py-8 md:py-12 lg:py-16 w-full max-w-4xl">
        <h2 className="font-eurostile font-semibold tracking-tight text-xl md:text-4xl lg:text-5xl text-black mb-4 md:mb-6 text-center">
          Behind the P+RTAL company
        </h2>
        <div className="flex justify-center w-full mb-6 md:mb-8">
          <div className="relative w-full max-w-md md:max-w-lg lg:max-w-xl aspect-[3/4] overflow-hidden" style={{ maxHeight: '40vh' }}>
            <Image
              src="/company.jpg"
        ...
        {/* Paragraphs */}
        <div className="relative z-50 flex flex-col px-6 max-w-4xl w-full pb-8 md:pb-12">
          <p className="text-base md:text-lg lg:text-xl text-black mb-4 md:mb-6 text-center">
