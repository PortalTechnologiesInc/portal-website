...
export default function ContactCarousel() {
  ...
  return (
    <div className="w-full h-[2.875rem] backdrop-blur-[0.625rem] bg-white/10 md:bg-[#FFED00]/[0.05] overflow-hidden flex items-center absolute md:relative bottom-0 md:bottom-auto left-0 z-[999]">
